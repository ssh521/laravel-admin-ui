                        ...
                        <div class="space-y-3">
                            <div class="{{ $rowClass }}">
                                ...
                                <div class="w-full sm:w-[260px]">
                                    <input id="name" name="name" type="text" value="{{ old('name', $role->name) }}" autocomplete="name" placeholder="{{ __('Enter role name') }}" class="{{ $inputClass }} w-full" onfocus="{{ $focusIn }}" onblur="{{ $focusOut }}">
                                    @if ($errors->has('name'))
                                        <x-laravel-admin::admin.input-error-message class="mt-2 text-[13px]" :messages="['역할명을 입력해 주세요!']" />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="{{ $rowClass }}">
                                ...
                                <div class="w-full sm:w-[420px]">
                                    <input id="description" name="description" type="text" value="{{ old('description', $role->description ?? '') }}" placeholder="{{ __('Enter role description') }}" class="{{ $inputClass }} w-full" onfocus="{{ $focusIn }}" onblur="{{ $focusOut }}">
