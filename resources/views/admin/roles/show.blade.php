    ...
    <x-slot name="header">
        <x-laravel-admin::admin.admin-header>
            <x-slot name="navigation">
                ...
                - <a href="{{ route('admin.roles.index') }}">역할 목록</a>
                - 상세
            </x-slot>
            ...
            <div class="mx-auto max-w-4xl">
                <div class="sm:flex sm:items-start sm:justify-between">
                    ...
                    <div class="mt-4 flex gap-2 sm:mt-0 sm:ml-6">
                        <x-laravel-admin::admin.action-button variant="secondary" size="sm" :href="route('admin.roles.index')" icon="list">
                            {{ __('목록보기') }}
                    ...
                    <div class="space-y-8">
                        <section>
                            <div class="mb-4">
                                ...
                                <p class="mt-1 text-sm leading-6 text-gray-500 dark:text-gray-400">{{ __('역할 이름과 설명입니다.') }}</p>
                            </div>
                        ...
                        <section class="border-t border-gray-200 pt-6 dark:border-gray-700">
                            <div class="mb-4">
                                <h3 class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ __('권한') }}</h3>
                                <p class="mt-1 text-sm leading-6 text-gray-500 dark:text-gray-400">{{ __('이 역할에 할당된 권한입니다.') }}</p>
                            </div>
                        ...
                        <section class="border-t border-gray-200 pt-6 dark:border-gray-700">
                            <div class="mb-4">
                                ...
                                <p class="mt-1 text-sm leading-6 text-gray-500 dark:text-gray-400">{{ __('역할 생성과 마지막 수정 시각입니다.') }}</p>
                            </div>
                            <dl class="grid grid-cols-1 border-t border-gray-100 sm:grid-cols-2 dark:border-gray-800">
                                <div class="px-0 py-4 sm:px-0 sm:py-5">
                ...
                <div class="border-t border-gray-200 bg-gray-50 px-4 py-4 sm:px-6 dark:border-gray-700 dark:bg-gray-800/70">
                    <div class="flex justify-end">
                        <div class="flex flex-wrap justify-end gap-2">
                            @can('update', $role)
                                <x-laravel-admin::admin.action-button :href="route('admin.roles.edit', $role)">
                                    {{ __('수정하기') }}
                                </x-laravel-admin::admin.action-button>
                            @endcan
                        </div>
