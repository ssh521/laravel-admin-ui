@props([
    ...
    'data' => null, // 모달에 전달할 추가 데이터
    'data-json' => null // JSON 형태의 데이터
])
...
@php
    ...
    // 데이터 처리
    $eventData = ['modalId' => $finalModalId];
    ...
    if ($attributes->get('data-json')) {
        $eventData['dataJson'] = $attributes->get('data-json');
    }
