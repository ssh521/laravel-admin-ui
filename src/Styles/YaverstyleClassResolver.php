...
class YaverstyleClassResolver implements StyleClassResolver
{
    ...
    {
        return match ($key) {
            'action-button.base' => 'laravel-admin-action-button inline-flex cursor-pointer items-center justify-center gap-2 rounded-md font-semibold transition hover:!no-underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
            ...
            'filter-bar' => 'mt-3 hidden flex-col gap-3 rounded-lg border border-gray-200 bg-gray-50 p-4 sm:mt-6 sm:flex sm:flex-row sm:items-center dark:border-gray-700 dark:bg-gray-800/70',
    ...
    private function badgeVariant(mixed $variant): string
    {
        ...
        return [
            ...
            'info' => 'bg-blue-50 text-blue-700 ring-blue-600/20 dark:bg-blue-500/10 dark:text-blue-300 dark:ring-blue-500/20',
